...
from .. import db
from ..models import Clients, Server
from ..forms.forms import frm_client
from ..utils import wireguard_keypair, wireguard_service, wireguard_build_server_config
...
def KeyPair():
    try:
        return {"status": True, "message": "Key pair generated", "data": wireguard_keypair()}
    except Exception:
