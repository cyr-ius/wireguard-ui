...
[Architecture](https://cyr-ius.github.io/wireguard-ui/fr/architecture/backend/)
...
**[Démarrage](https://cyr-ius.github.io/wireguard-ui/fr/demarrage/quickstart-docker/)**.
...
**[cyr-ius.github.io/wireguard-ui](https://cyr-ius.github.io/wireguard-ui/fr/)**.

| Vous cherchez...                                  | Allez à...                                                                                                |
| ------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| Toutes les variables d'environnement              | [Variables d'environnement](https://cyr-ius.github.io/wireguard-ui/fr/demarrage/variables-environnement/) |
| Installation locale (dev, sans Docker)            | [Installation locale](https://cyr-ius.github.io/wireguard-ui/fr/demarrage/installation-locale/)           |
| Architecture backend / frontend / base de données | [Architecture](https://cyr-ius.github.io/wireguard-ui/fr/architecture/backend/)                           |
| Routers, services métier, authentification        | [Fonctions & API](https://cyr-ius.github.io/wireguard-ui/fr/fonctions/routers/)                           |
| Déploiement & recommandations production          | [Déploiement](https://cyr-ius.github.io/wireguard-ui/fr/deploiement/docker/)                              |
