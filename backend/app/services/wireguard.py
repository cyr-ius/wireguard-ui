...
async def restart_service(interface: str = "wg0") -> None:
    """Stop then restart the WireGuard interface."""
    try:
...
def build_client_config(
    ...
    """Build and return the WireGuard .conf file content for a client."""
    lines = [
...
def build_server_config(server: WireGuardServer, clients: list[WireGuardClient]) -> str:
    """Build and return the WireGuard server .conf file content including enabled peers."""
    try:
